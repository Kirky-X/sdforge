...
This project is indexed by GitNexus as **sdforge** (5221 symbols, 13006 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
