...
#[cfg(feature = "mcp")]
define_registration!(McpToolRegistration, Arc<dyn mcp_sdk::tools::Tool>, ApiMetadata);
...
mod tests {
    ...
    fn test_mcp_tool_registration() {
        ...
        let registration =
            McpToolRegistration::new("test_tool", "v1", create_test_tool, || {
                ApiMetadata {
    ...
    fn test_mcp_tool_registration_const_fn() {
        ...
        const REGISTRATION: McpToolRegistration =
            McpToolRegistration::new("const_test", "v1", create_const_tool, || {
                ApiMetadata {
    ...
    fn test_mcp_tool_registration_clone() {
        ...
        let reg = McpToolRegistration::new("clone_tool", "v1", create_tool, || {
            ApiMetadata {
    ...
    fn test_mcp_tool_registration_debug_impl() {
        ...
        let reg = McpToolRegistration::new("debug_tool", "v1", create_tool, || {
            ApiMetadata {
